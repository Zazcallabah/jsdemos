...
namespace HashName
{
	...
	{
		public static string AsHex( this uint data )
		{
			return ( (int) data ).AsHex();
		}

		public static string AsHex( this int data )
		{
	...
	/// // code stolen from http://www.theitguys.biz/?XYsDlstU
	/// </summary>
	public class Crc32
	{
